"""Re-import v15 and verify the four reported top-view openings stay closed."""
...
GLB = ROOT / "godot-game/assets/3d/dark_fantasy/mercenary_crossbowman_game_ready_v15.glb"
RECTS = (
    (718, 756, 256, 264),
    (430, 448, 266, 272),
    (386, 404, 280, 284),
...
print("V15_EXPORTED_MESH_COUNT", mesh_count)
print("V15_EXPORTED_TOP_CLOSE_MISSES", misses_by_rect)
if mesh_count != 12 or any(misses_by_rect):
    raise RuntimeError(
        f"Exported v15 ray audit failed: meshes={mesh_count}, misses={misses_by_rect}"
    )
