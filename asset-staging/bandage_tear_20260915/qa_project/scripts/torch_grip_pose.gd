...
const CARRY_POSITION := Vector3(-0.82, -0.39, -0.40)
const CARRY_ROTATION := Vector3(20, 30, 0)
const DRAW_DURATION := 1.05
const DRAW_REVEAL_TIME := 0.60
const STOW_DURATION := 0.90
const DRAW_POSITION := Vector3(-0.48, -0.86, -0.82)
const DRAW_ROTATION := Vector3(12, 30, 0)
const STOW_POSITION := Vector3(-0.48, -1.85, -0.82)
const STOW_ROTATION := Vector3(12, 30, 0)
