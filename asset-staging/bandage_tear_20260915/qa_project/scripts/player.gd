...
func _build_viewmodel() -> void:
	...
	viewmodel_renderer.setup(camera, [weapon_pivot, shield_pivot, torch_pivot, support_arm_root, bandage_hands])
...
func _refresh_carried_visibility() -> void:
	var treating: bool = is_bandage_motion_active() and bool(bandage_hands.equipment_hidden())
...
func is_bandage_motion_active() -> bool:
	return is_instance_valid(bandage_hands) and bool(bandage_hands.active)
