...
func _spawn_encounters() -> void:
	var guards := {
		...
		"drowned_miner": ["굶주린 침수 갱도의 광부", 65.0, 17.0, 2.1, "bleeding"],
	...
	var hazards := {
		"workshop_rune": ["작업실의 속박 룬", 27.0, 0.82, 0.60, "curse"],
...
func _spawn_loot_chests() -> void:
	_spawn_loot_chest("남쪽 갱도의 원정 보급품", _placement_position("chests", "entry_supplies"), [
		{"id": "linen_bandage", "quantity": 3},
		{"id": "lamp_oil", "quantity": 3},
		{"id": "pilgrim_ration", "quantity": 3},
		{"id": "boiled_rainwater", "quantity": 3},
		{"id": "camp_kit", "quantity": 1},
		{"id": "hunting_bow", "quantity": 1},
		{"id": "wooden_arrow", "quantity": 18},
	], "남쪽 진입 갱도 · 긴 원정을 위한 보급")
	_spawn_loot_chest("익사한 광부의 유품 상자", _placement_position("chests", "drowned_cache"), [
		{"id": "silver_chalice", "quantity": 1},
		{"id": "water_spellbook", "quantity": 1},
		{"id": "weathered_staff", "quantity": 1},
		{"id": "boiled_rainwater", "quantity": 2},
	], "상부 침수 갱도 · 물가에 남은 유품")
	_spawn_loot_chest("감독관의 잠긴 궤짝", _placement_position("chests", "foreman_cache"), [
		{"id": "stone_spellbook", "quantity": 1},
		{"id": "chain_flail", "quantity": 1},
		{"id": "rune_fragment", "quantity": 3},
		{"id": "lamp_oil", "quantity": 2},
	], "감독관 작업실 · 광부가 남긴 보관품")
	_spawn_loot_chest("폐창고의 운송 상자", _placement_position("chests", "store_cache"), [
		{"id": "reliquary", "quantity": 1},
		{"id": "healing_draught", "quantity": 2},
		{"id": "healing_spellbook", "quantity": 1},
		{"id": "black_salt", "quantity": 2},
	], "동쪽 자재 창고 · 버려진 운송품")
	_spawn_loot_chest("기둥 성소의 봉헌물", _placement_position("chests", "shrine_treasure"), [
		{"id": "silver_chalice", "quantity": 2},
		{"id": "rune_fragment", "quantity": 4},
		{"id": "fire_spellbook", "quantity": 1},
		{"id": "ice_spellbook", "quantity": 1},
	], "기둥 성소 · 감시자가 지키는 봉헌물")
