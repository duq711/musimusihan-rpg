...
func _test_inventory_visual_metadata() -> void:
	_check(ExpeditionInventory.ITEM_DEFINITIONS.size() == 28, "item catalog must keep all twenty-eight authored visual definitions including both cooking ingredients")
