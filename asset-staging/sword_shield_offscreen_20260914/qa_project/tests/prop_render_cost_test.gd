...
func _census(root_node: Node) -> Dictionary:
	var data := {"node_count": 0, "mesh_instances": 0, "visible_mesh_instances": 0, "multimesh_batches": 0, "multimesh_instances": 0, "visible_surfaces": 0, "visible_triangles": 0, "visible_vertices": 0, "shadow_casting_meshes": 0, "shadow_only_meshes": 0, "shadow_only_triangles": 0, "unique_visible_meshes": 0, "unique_visible_materials": 0, "triplanar_surfaces": 0, "transparent_surfaces": 0, "lights": [], "particle_systems": [], "largest_meshes": [], "mesh_name_families": {}, "regions": {}}
	var meshes := {}
	var materials := {}
...
func _visit(node: Node, parent_visible: bool, data: Dictionary, meshes: Dictionary, materials: Dictionary, region: String) -> void:
	...
	if node is MeshInstance3D:
		...
		if visible and instance.mesh != null and instance.cast_shadow == GeometryInstance3D.SHADOW_CASTING_SETTING_SHADOWS_ONLY:
			data.shadow_only_meshes += 1
			data.shadow_casting_meshes += 1
			data.shadow_only_triangles += instance.mesh.get_faces().size() / 3
		elif visible and instance.mesh != null:
