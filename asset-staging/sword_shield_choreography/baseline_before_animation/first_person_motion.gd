...
static func sword(phase: String, elapsed: float, charge: float = 0.0, guard := false, shield := true) -> Transform3D:
	var ready := pose(Vector3(0.705, -0.387, -0.830), Vector3(-18.93, -24.44, 13.59))
