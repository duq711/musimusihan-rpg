...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("motion_shield", "기본", "1인칭 모션 · 검과 방패", "검·방패와 관절형 양손 · RMB 준비/가드/충격 · 방어 후 LMB 반격", "first_person_motion", "shield"),
		...
		_entry("hideout", "장면", "3D 은신처 · 생활 기능", "침상 / 보관함 / 화로 / 대장간 / 식사 / 세면 / 원정 지도", "scene", "res://hideout.tscn"),
