...
frames = root / 'godot-game/artifacts/visual_qa/bandage_forearm/transition_05'
...
video = frames/'bandage_transition.mp4'
...
with av.open(str(video), 'w', options={'movflags': '+faststart'}) as container:
    ...
    for frame in manifest['frames']:
        ...
        draw.text((24,20), '붕대 감기 · 무기 수납과 팔 들기', font=font, fill='#f1eee7')
