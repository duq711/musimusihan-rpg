...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_hands_detailed", "기본", "캐릭터 그래픽 · 양손 디테일 모델", "그레이박스와 같은 실제 양손 자세 · 손가락·손톱·장갑·소매 세부 비교 · 왼쪽 상자 E · I 활 장착", "player_hands_detailed"),
		_entry("player_finger_joints", "기본", "캐릭터 그래픽 · 손가락 마디별 관절", "실제 양손 확대 검토 · 손가락 15마디 독립 조절 · 손등/손바닥 · 펴기/주먹/순차 굽힘 · F2 복귀", "player_finger_joints"),
		...
		_entry("motion_sword_run", "기본", "영상 참고 검 모션 · 달리기", "검·방패와 중앙 통로 · W / Shift 걷기·달리기·멈추기의 검 궤적과 팔 연결 비교 · F2 재시험", "reference_sword_motion", "run"),
		...
		_entry("motion_shield_raise", "기본", "검과 방패 · 방패 올리기", "정지 상대 · RMB 누르기/놓기로 방패 올리기·내리기 반복 · F2 재시험", "first_person_motion", "shield_raise"),
		_entry("motion_shield_impact", "기본", "검과 방패 · 막힘 충격", "실제 공격 상대 · RMB를 유지해 막힘 충격 확인 · 놓고 LMB 반격 · F2 회복", "first_person_motion", "shield_impact"),
		...
		_entry("motion_torch", "기본", "1인칭 모션 · 횃불과 보행", "왼손 횃불과 빈 오른손 자동 준비 · WASD 걷기 / Shift 달리기 / F 소등", "first_person_motion", "torch"),
		_entry("motion_chest", "기본", "1인칭 모션 · 맨손 조사와 열기", "실제 닫힌 상자 · E 조사/손 접촉/뚜껑 들기 · F2 정리 후 재시험", "first_person_motion", "chest"),
		...
		_entry("hideout", "장면", "3D 은신처 · 생활 기능", "침상 / 보관함 / 화로 / 대장간 / 연금술 / 식사 / 세면 / 원정 지도", "scene", "res://hideout.tscn"),
