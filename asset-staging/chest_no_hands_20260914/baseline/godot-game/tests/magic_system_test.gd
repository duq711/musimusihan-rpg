...
func _finish() -> void:
	if failures.is_empty():
		print("MAGIC SYSTEM TEST PASS: books, persistence, staff gate, unarmed state, attack cancellation, stamina, cooldown, swept-sphere physics, six spells, merchant, and dungeon loot")
		quit(0)
		return
