...
func _run() -> void:
	...
	_check(room.inventory_overlay.combined_loadout_panel.is_visible_in_tree() and room.inventory_overlay.combined_loadout_panel.inventory_buttons.size() == 30 and room.inventory_overlay.combined_loadout_panel.equipment_buttons.size() == 5, "The executable body trial must expose real equipment and all storage alongside treatment.")
