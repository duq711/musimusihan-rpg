...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("motion_sword", "기본", "1인칭 모션 · 검 준비와 타격", "실제 검과 정면 표적 · LMB 준비/타격/회수 · 길게 눌러 강공격 · F2 재시험", "first_person_motion", "sword"),
		_entry("motion_shield", "기본", "1인칭 모션 · 검과 방패", "검·방패와 관절형 양손 · LMB 세 베기 순환 · RMB 올리기/충격 · 방어 후 반격", "first_person_motion", "shield"),
		...
		_entry("motion_shield_cut_overhead", "기본", "검과 방패 · 상단 내려베기", "검·방패와 2m 정지 표적 · LMB로 머리 위 준비→내려베기→회수 반복 · F2 재시험", "first_person_motion", "shield_cut_overhead"),
