...
out = root / 'forehand_grip_direction_comparison'
...
clips = [('right_diagonal', '수정 전 정베기'), ('right_diagonal', '칼 방향 수정 후 정베기')]
stances = [('forehand_grip_direction_two_hand', '양손 파지', 'forehand_from_reverse_final_two_hand'), ('forehand_grip_direction_shield', '방패 착용', 'forehand_from_reverse_final_shield')]
video = out / 'forehand_grip_comparison.mp4'
