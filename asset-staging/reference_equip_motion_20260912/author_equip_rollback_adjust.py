...
OUT=ROOT/'iteration_rollback_adjust'; OUT.mkdir(exist_ok=True)
V=lambda x:Vector(x)
...
stowed=held((-.35,-.82,-.30),(-.65,-.75,-.10),20)
sk=[(0,stowed),(.42,stowed),(.52,held((-.31,-.59,-.36),(-.65,-.75,-.15),35)),(.67,held((-.125,-.12,-.42),(-.62,-.76,-.15),55)),(.75,held((.30,.015,-.45),(-.63,-.76,-.15),50)),(.83,held((.48,-.02,-.46),(-.95,-.22,-.20),25)),(.94,held((.49,-.11,-.46),(-.89,.42,-.20),-10)),(1.08,held((.36,-.35,-.46),(-.30,.95,-.10),-28)),(1.28,idle),(1.5,idle)]
