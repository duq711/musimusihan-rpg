...
labels={'draw':'검·방패 꺼내기','idle':'대기','walk':'걷기','run':'달리기','jump':'도약 · 공중 · 착지','overhead':'내려베기','left_reverse':'왼쪽 → 오른쪽 베기','right_diagonal':'오른쪽 → 왼쪽 베기'}
...
for seq in (root/'sequences').iterdir():
 ...
 else:sel=[fs[min(len(fs)-1,i)] for i in [0,6,12,18,24,30,36,40,45,50,56,62,68,74,84,100]]
