...
func _run() -> void:
	...
	cut_refinement_review = requested_scope in ["cut_refinement", "quick_cut"]
	quick_cut_review = requested_scope in ["quick_cut", "quick_cut_shield"]
