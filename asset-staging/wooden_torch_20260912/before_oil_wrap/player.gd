...
const TORCH_FIRE := preload("res://scripts/torch_spatial_fire.gd")
...
func _update_torch(delta: float) -> void:
	...
	# The raymarched volume animates internally; keep its foot anchored to the wick.
