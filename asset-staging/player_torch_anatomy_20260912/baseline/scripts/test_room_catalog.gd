...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_hands_detailed", "기본", "캐릭터 그래픽 · 제공 모델 양손", "제공한 손 형상·손톱·소매 연결 · 기본 외형과 같은 양손 · 상자 E · I 활", "player_hands_detailed"),
		...
		_entry("motion_torch", "기본", "1인칭 모션 · 횃불과 보행", "횃불 전용 손목 정렬·중간 마디 접촉·엄지 파지 · WASD 걷기 / Shift 달리기 / F 소등", "first_person_motion", "torch"),
