...
const SOURCES = ["res://tests/torch_grip_preview.gd","res://scripts/player.gd","res://scripts/player_arm_visual.gd","res://scripts/greybox_arm_visual.gd","res://scripts/torch_grip_pose.gd","res://assets/3d/player/hands_detailed/left_hand_detailed.glb","res://assets/3d/dark_fantasy/iron_cage_torch.glb"]
