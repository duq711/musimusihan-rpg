...
frames = root / 'godot-game/artifacts/visual_qa/bandage_forearm/alignment_02'
...
video = frames/'bandage_alignment.mp4'
...
with av.open(str(video), 'w', options={'movflags': '+faststart'}) as container:
    ...
    for frame in manifest['frames']:
        ...
        draw.text((24,20), '붕대 감기 · 손과 팔 연결 수정', font=font, fill='#f1eee7')
