...
bpy.ops.wm.open_mainfile(filepath=str(stage/'mac_output/geometry_04_thumb/bilateral_hands_finger_detail.blend'));scene,rigs=a.activate();r={'checks':{},'errors':{}}
...
(stage/'audit/nail_bed_geometry04.json').write_text(json.dumps(r,indent=2));print('NAIL_BED_PROBE',len(r['checks']),json.dumps(r['errors']))
