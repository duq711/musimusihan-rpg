...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_hands_detailed", "기본", "캐릭터 그래픽 · 장갑 손 비례 조정", "원래 장갑·색·소매·봉제선 유지 · 사진 참고 손바닥·손목·손가락 비례 · 상자 E · I 활", "player_hands_detailed"),
		_entry("player_finger_joints", "기본", "캐릭터 그래픽 · 손가락 마디별 관절", "장갑 손 비례와 15마디 굽힘 · 손등/손바닥/손목 옆면 · 펴기/주먹/순차 · F2 복귀", "player_finger_joints"),
