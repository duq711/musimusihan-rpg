...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_hands_detailed", "기본", "캐릭터 그래픽 · 양손 디테일 모델", "피부색·주름·마디와 손톱·가죽·천 재질 · 실제 양손 비교 · 왼쪽 상자 E · I 활 장착", "player_hands_detailed"),
		_entry("player_finger_joints", "기본", "캐릭터 그래픽 · 손가락 마디별 관절", "피부 주름과 15마디 굽힘 · 손등/손바닥/손목 옆면 · 펴기/주먹/순차 · F2 복귀", "player_finger_joints"),
