...
p=out.parent.parent/'godot-game/artifacts/visual_qa/potion_drink/mouth_angle_05'
...
frames[0].save(out/'potion_mouth_angle.gif',save_all=True,append_images=frames[1:],duration=67,loop=0,optimize=False)
...
ids=[30,70,82,92,105,120,140,159,175]
