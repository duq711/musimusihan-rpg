...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_hands_detailed", "기본", "캐릭터 그래픽 · 사진 참고 맨손", "사진 비례의 손가락·손바닥·손목과 피부 주름 · 맨손·상자 E·I 활 비교", "player_hands_detailed"),
		_entry("player_finger_joints", "기본", "캐릭터 그래픽 · 손가락 마디별 관절", "사진 참고 맨손의 피부·15마디 굽힘 · 손등/손바닥/손목 옆면 · 펴기/주먹/순차 · F2 복귀", "player_finger_joints"),
