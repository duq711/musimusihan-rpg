...
func _build_viewmodel() -> void:
	...
	viewmodel_renderer.setup(camera, [weapon_pivot, shield_pivot, torch_pivot, support_arm_root, bandage_hands, splint_hands])
...
func is_bandage_motion_active() -> bool:
	return (is_instance_valid(bandage_hands) and bool(bandage_hands.active)) or (is_instance_valid(splint_hands) and bool(splint_hands.active))
