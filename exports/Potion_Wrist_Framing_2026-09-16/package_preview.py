...
p=out.parent.parent/'godot-game/artifacts/visual_qa/potion_drink/wrist_frame_01'
...
frames[0].save(out/'potion_wrist_framing.gif',save_all=True,append_images=frames[1:],duration=67,loop=0,optimize=False)
