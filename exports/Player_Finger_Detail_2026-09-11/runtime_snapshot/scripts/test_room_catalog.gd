...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_hands_detailed", "기본", "캐릭터 그래픽 · 손가락 피부 디테일", "손가락별 앞·뒷면 기준 · 피부결·지문·손톱 · 기존 장갑·비례 유지 · 상자 E · I 활", "player_hands_detailed"),
		_entry("player_finger_joints", "기본", "캐릭터 그래픽 · 손가락 마디별 관절", "피부·손톱 디테일과 15마디 굽힘 · 손등/손바닥/손목 옆면 · 펴기/주먹/순차 · F2 복귀", "player_finger_joints"),
