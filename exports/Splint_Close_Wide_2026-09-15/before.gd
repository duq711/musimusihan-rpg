...
func set_time(seconds: float) -> void:
	...
	_wrist = Vector3(-0.20, -0.18, -0.48) + shift + gesture + sway
	_elbow = Vector3(-0.56, -0.13, -0.10) + shift + gesture * 0.35 + sway
	...
	right_arm.fit_arm(to_global(Vector3(0.60, -0.60, -0.15)), to_global(Vector3(0.28, -0.40, -0.12)))
