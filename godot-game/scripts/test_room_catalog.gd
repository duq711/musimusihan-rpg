...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("creep_execution", "기본", "크리프 처형 · 포복 찌르기", "실제 왼다리 절단·랙돌 착지·회복 후 LMB 0.4초 이상 → 놓기 · 준비→첫 찌르기→깊게 밀며 움찔→잠시 유지→회수 · F2 정지·재선택", "creep_execution", "left_leg"),
		_entry("creep_execution:both_legs", "기본", "크리프 처형 · 양다리 포복", "실제 양다리 절단·랙돌 착지·회복 후 준비→첫 찌르기→깊게 밀며 움찔→잠시 유지→회수 · 1번 방패 수납 가능 · LMB 0.4초 이상 → 놓기", "creep_execution", "both_legs"),
