...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("rear_takedown", "기본", "검 제압 · 미인지 후방", "건강한 크리프 등 뒤에서 E 제압 · 어깨 뒤로 밀착해 반대편 관통 칼날 확인·첫 접촉 혈흔·고개 반응→짧은 비틀기 반응→직선 회수 · 칼끝이 빠진 뒤 머리 유지 랙돌 · F2 정지·회복·재선택", "rear_takedown", "rear"),
