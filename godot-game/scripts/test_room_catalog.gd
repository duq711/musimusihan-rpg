...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("camping", "생존", "야영 · 휴식과 응급처치", "가방의 야영 도구 설치 → 초록 LMB → 텐트 E · 휴식·식사·처치 · 보급 각 2개", "camping"),
		_entry("camp_placement", "생존", "야영 · 빨강/초록 설치 판정", "가방의 야영 도구 설치 · 열린 바닥 초록 / 장애물·벽·위쪽 빨강 · LMB 확정 / F 취소", "camp_placement"),
		_entry("cooking", "생존", "야영 · 요리하고 먹기", "가방의 야영 도구 설치 → 텐트 E → 요리 · 실제 재료 / 완성 즉시 식사 · F2 재시험", "cooking"),
		_entry("stress_meter", "생존", "스트레스 · 누적과 회복", "스트레스 30 · 허기·갈증·출혈 / F 소등 · 설치한 텐트 E로 회복", "stress", "30"),
		_entry("stress_audio", "생존", "스트레스 · 환청", "스트레스 65 · 잠시 기다려 속삭임·발소리 확인 · 가방에서 야영 도구 설치", "stress", "65"),
		_entry("stress_vision", "생존", "스트레스 · 환영과 환청", "스트레스 90 · 비전투 실루엣과 소리 · F2 정리 / 가방 설치 → 텐트 E", "stress", "90"),
