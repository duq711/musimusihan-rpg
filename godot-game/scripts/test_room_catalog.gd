...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_appearance", "기본", "플레이어 외형 · 3D 캐릭터", "실제 인벤토리 3D 초상 · Medival 의상만 표시 · 회전·F2 재시험", "player_appearance"),
		_entry("player_cloth_motion", "기본", "플레이어 의상 · 이동 관찰", "원본 의상 5개 메시를 실제 플레이어에서 관찰 · WASD 걷기 / Shift 달리기 / F2 복귀·재시험 · 천 물리 미적용", "player_cloth_motion"),
