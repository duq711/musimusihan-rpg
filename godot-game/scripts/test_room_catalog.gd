...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("player_appearance", "기본", "플레이어 외형 · 3D 캐릭터", "실제 인벤토리 3D 초상 · 로컬 Roger의 Medival 착용 / 미설치 시 의상만 표시 · 회전·F2 재시험", "player_appearance"),
		_entry("player_cloth_motion", "기본", "플레이어 의상 · 이동 관찰", "실제 플레이어의 몸·의상 배치 관찰 · WASD 걷기 / Shift 달리기 / F2 복귀·재시험 · 정적 자세·천 물리 미적용", "player_cloth_motion"),
