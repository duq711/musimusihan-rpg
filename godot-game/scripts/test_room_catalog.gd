...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("creep_dismemberment:left_leg", "기본", "크리프 절단 · 왼다리", "왼다리에 0.8초 간격 18 피해 2회 · 절단 후 기어서 추적·공격 · F2 일시정지 / 재선택", "creep_dismemberment", "left_leg"),
		_entry("creep_dismemberment:right_leg", "기본", "크리프 절단 · 오른다리", "오른다리에 0.8초 간격 18 피해 2회 · 절단 후 기어서 추적·공격 · F2 일시정지 / 재선택", "creep_dismemberment", "right_leg"),
		_entry("creep_dismemberment:both_legs", "기본", "크리프 절단 · 양다리 기어가기", "시험 체력 118 · 양다리에 18 피해씩 2회, 총 4회 · 살아서 기어 추적·공격 · F2 일시정지 / 재선택", "creep_dismemberment", "both_legs"),
