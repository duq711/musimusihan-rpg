...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("rear_takedown", "기본", "검 제압 · 미인지 후방", "건강한 크리프 등 뒤에서 E 제압 · 첫 실제 접촉의 3D 혈흔 1회·깊은 찌르기 반응→짧은 비틀기 반응→직선 회수 · 옆 베기 없음·칼끝이 빠진 뒤 머리 유지 랙돌 · F2 정지·회복·재선택", "rear_takedown", "rear"),
