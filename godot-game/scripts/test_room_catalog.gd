...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("shield_damage:high", "기본", "방패 파손 · 상 (75)", "실제 장착 방패 내구도 75 · 1인칭 대기/RMB 가드에서 판·철테 비교 · F2 재선택", "shield_damage", "high"),
		...
		_entry("rear_takedown", "기본", "검 제압 · 미인지 후방", "건강한 크리프 등 뒤에서 E 제압 · 등·어깨 바로 뒤 밀착·파지 손은 시야 밖·반대편 관통 칼날 확인·첫 접촉 혈흔·고개 반응→짧은 비틀기 반응→직선 회수 · 칼끝이 빠진 뒤 머리 유지 랙돌 · F2 정지·회복·재선택", "rear_takedown", "rear"),
		...
		_entry("creep_dismemberment:left_arm", "기본", "크리프 절단 · 왼팔", "왼팔에 0.8초 간격 18 피해 2회 · 절단 후 전투 계속 · F2 일시정지 / 재선택", "creep_dismemberment", "left_arm"),
		_entry("creep_dismemberment:right_arm", "기본", "크리프 절단 · 오른팔", "오른팔에 0.8초 간격 18 피해 2회 · 절단 후 전투 계속 · F2 일시정지 / 재선택", "creep_dismemberment", "right_arm"),
		_entry("creep_dismemberment:left_leg", "기본", "크리프 절단 · 왼다리", "18 피해 2회 · 랙돌 착지 후 남은 다리 관절·골반을 움직여 기어 추적 · F2 일시정지 / 재선택", "creep_dismemberment", "left_leg"),
		_entry("creep_dismemberment:right_leg", "기본", "크리프 절단 · 오른다리", "18 피해 2회 · 랙돌 착지 후 남은 다리 관절·골반을 움직여 기어 추적 · F2 일시정지 / 재선택", "creep_dismemberment", "right_leg"),
		_entry("creep_dismemberment:both_legs", "기본", "크리프 절단 · 양다리 기어가기", "시험 체력 118 · 18 피해씩 총 4회 · 랙돌 착지 후 골반의 무게 이동으로 기어 추적 · F2 일시정지 / 재선택", "creep_dismemberment", "both_legs"),
		_entry("creep_dismemberment:head", "기본", "크리프 절단 · 머리", "머리에 0.8초 간격 18 피해 2회 · 머리 절단과 실제 사망·보상 · F2 일시정지 / 재선택", "creep_dismemberment", "head"),
		_entry("creep_execution", "기본", "크리프 처형 · 포복 찌르기", "실제 왼다리 절단·랙돌 착지·회복 후 LMB 0.4초 이상 → 놓기 · 준비→첫 찌르기→칼날 55% 밀며 움찔→잠시 유지→회수·칼이 빠지면 랙돌 · F2 정지·재선택", "creep_execution", "left_leg"),
		_entry("creep_execution:both_legs", "기본", "크리프 처형 · 양다리 포복", "실제 양다리 절단·랙돌 착지·회복 후 준비→첫 찌르기→칼날 55% 밀며 움찔→잠시 유지→회수·칼이 빠지면 랙돌 · 1번 방패 수납 가능 · LMB 0.4초 이상 → 놓기", "creep_execution", "both_legs"),
