...
static func entries() -> Array[Dictionary]:
	var result: Array[Dictionary] = [
		...
		_entry("creep_dismemberment:left_leg", "기본", "크리프 절단 · 왼다리", "왼다리에 0.8초 간격 18 피해 2회 · 절단 후 전투 계속 · F2 일시정지 / 재선택", "creep_dismemberment", "left_leg"),
		_entry("creep_dismemberment:right_leg", "기본", "크리프 절단 · 오른다리", "오른다리에 0.8초 간격 18 피해 2회 · 절단 후 전투 계속 · F2 일시정지 / 재선택", "creep_dismemberment", "right_leg"),
