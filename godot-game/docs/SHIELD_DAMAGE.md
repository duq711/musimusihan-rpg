...
## 2026-09-19 절단면의 나이테·목섬유 보완 / Fracture growth rings and wood fibres
...
기존 파손 실루엣은 유지한다. 미세 요철은 빛에 반응하는 표면 표현이며 새로 떨어져 나오는 목섬유·파편 형상을 추가한 것은 아니다. 이번 재질 검수는 위의 기존 3단계 구현 검수와 구분하며 새 OS 직접 입력·전체 던전 플레이 검수는 하지 않았다.
